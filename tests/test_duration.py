...
(``ms``, ``s``, ``m``, ``h``) into integer milliseconds. Malformed, ambiguous,
or unsupported inputs must raise ``ValueError``.
"""
...
# ---------------------------------------------------------------------------
# Required examples — one per supported unit (the four specified conversions)
# ---------------------------------------------------------------------------
